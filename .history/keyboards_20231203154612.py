...
keyboard_select_tarif2 = InlineKeyboardMarkup(resize_keyboard=True)
button_2 = InlineKeyboardButton(text=SEND_TARIF_PREMIUM, callback_data=SEND_TARIF_PREMIUM, parse_mode="HTML")
button_3 = InlineKeyboardButton(text=SETTINGS, callback_data=SETTINGS, parse_mode="HTML")
keyboard_select_tarif2.add(*[button_2, button_3])
