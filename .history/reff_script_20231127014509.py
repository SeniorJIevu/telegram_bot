...
for folder in sorted(subfolders_list):
    ...
    subfolders_dict[folder] = OrderedDict(sorted(sub_subfolders_dict.items(), key=lambda x: int(x[0])))

    
output_file = 'references/1244.py'
