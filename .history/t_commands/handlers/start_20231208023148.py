...
@dp.message_handler(NoSpamFilter(), commands=['start'])
...
@dp.callback_query_handler(NoButtonSpamFilter(),lambda call: call.data == "Начать", state=OrderStart.send_start,)
...
@dp.callback_query_handler(NoButtonSpamFilter())
