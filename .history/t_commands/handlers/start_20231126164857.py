    ...
    try:
        ...
        if is_user_exist:
            ...
            async with aiofiles.open(
                ...
                await message.delete_reply_markup(chat_id=message.chat.id, message_id=message.message_id)
...
После ознакомления, загрузи 1 фото
    ...
    async with aiofiles.open("images/send_photo.jpg", mode="rb") as photo:
        ...
        await call.message.delete_reply_markup(chat_id=call.message.chat.id, message_id=call.message.message_id)
