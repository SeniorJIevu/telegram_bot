...
def register_handler_start(dp: Dispatcher):
    dp.register_message_handler(send_age ,state=OrderStart.send_age.state)
    dp.register_message_handler(send_start,commands="start", state=OrderStart.confirmed_age.state)
