...
@dp.callback_query_handler(state=OrderStart.confirmed_age)
...
@dp.callback_query_handler(state=OrderStart.send_age)    
async def send_age( call: types.CallbackQuery, state: FSMContext, db: asyncpg.pool.Pool)  :
      try:
            print('a')
...
def register_handler_start(dp: Dispatcher):
    dp.register_message_handler(send_start_confirm, commands="start", state="*")
