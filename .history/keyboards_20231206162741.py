...
#select confirmed of age

keyboard_conf_age = InlineKeyboardMarkup(resize_keyboard=True, row_width=1) 
button_2 = InlineKeyboardButton(text=TRUE_AGE, callback_data=TRUE_AGE)
button_4 = InlineKeyboardButton(text=FALSE_AGE, callback_data=FALSE_AGE)
