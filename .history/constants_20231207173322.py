...
class ThrottlingMiddleware(BaseMiddleware):
    ...
    async def on_process_message(self, message: TelegramObject, data: dict):
        print('ТУТ2')
        """
        ...
        if handler:
            ...
            key = getattr(handler, 'throttling_key', f"{self.prefix}_{handler}")
        else:
            print('ТУТ5')
    ...
    async def message_throttled(self, message: TelegramObject, throttled: Throttled):
        print('ТУТ3')
        """
